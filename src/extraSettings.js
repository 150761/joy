...
const minRandomFruitNum = reverseLevelUp ? 5 : 1; // 生成随机水果最小值（0-10）0 为葡萄，9 为半个西瓜
const maxRandomFruitNum = reverseLevelUp ? 9 : 6; // 生成随机水果最大值（1-11）0 为葡萄，9 为半个西瓜
let setFruits = {
  // 指定前几次生成的水果，可填入任意数量的数字，0 为葡萄，9 为半个西瓜
  startFruits: reverseLevelUp ? [9, 9, 8, 7, 7, 6] : [0, 0, 1, 2, 2, 3],
  randomFunction: () => {
...
let adLink = "https://www.bilibili.com/video/BV1ah411Z7wa?from=search&seid=8614136405946484846";

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = '合成小芮芮';
